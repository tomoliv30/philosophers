...
/*   Updated: 2021/01/09 11:23:44 by totartar      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (sem_close(env->death_sem)
		| sem_close(env->log_sem)
		| sem_close(env->forks_sem)
		| sem_close(env->n_meals_sem)
		| sem_close(env->last_meal_sem)
